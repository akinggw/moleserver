        ...
        case 1000: {
            switch (objgame.MsgSubId) {
                ...
                case 1002:
                {
                    ...
                    var pCardType = objgame.CardType;
                    ...
                    m_labelallJettons.setString("总下注:"+m_allusertotalJettons);
                    m_labelCurJetton.setString("当前下注:"+m_meusertotalJettons);
                }
                    break;
                case 1003:
                {
                    m_curGamingResult = objgame.curGamingResult;
                    var pusertotalresultlist = objgame.usertotalresultlist;
                    ...
                    clearAnimation();
                    addvaluetogamerecord(m_cbCardListData[m_curGamingResult]);
                    ShowGamingRecords();
                ...
                case 1005:
                {
                    ...
                    m_CurShangZhuangCount = objgame.TotalShangZhuangCount;
                    m_ZhuangTotalWinResult = objgame.TotalShangZhuangCount;
                ...
                case 1004:
                    {
                        ...
                        if(GameRecords != null) {
                            for(var value of GameRecords) {
                                addvaluetogamerecord(m_cbCardListData[value]);
                            }
