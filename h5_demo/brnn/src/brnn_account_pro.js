...
var CRegisterLayer = cc.LayerColor.extend({
    ...
    init: function () {
        ...
        this._boxusername.setPlaceholderFontColor(cc.color(255,255,255));
        this._boxusername.setPlaceHolder("请输入用户名");
        this._boxusername.setPosition(size.width/2-60,size.height/2+5);
        this._boxusername.setFontColor(cc.color(255,255,255));
        ...
        this._boxuserpassword.setPlaceholderFontColor(cc.color(255,255,255));
        this._boxuserpassword.setPlaceHolder("请输入用户密码");
        this._boxuserpassword.setInputFlag(cc.EDITBOX_INPUT_FLAG_PASSWORD);
        this._boxuserpassword.setPosition(size.width/2-60,size.height/2-68);
        this._boxuserpassword.setFontColor(cc.color(255,255,255));
        ...
        RegisterBtnItem.setPosition(size.width/2,85);
...
var CLoginLayer = cc.LayerColor.extend({
    ...
    init: function () {
        ...
        menu.setPosition(0, 0);
        this.addChild(menu, 1);
        LoginBtnItem.setPosition(322,85);
        RegisterBtnItem.setPosition(489,85);
    }
});
...
function OnProcessAccountSocketOnOpen() {
    ...
    m_MainFrameLayer.addChild(v_MainLoginlayer,200000);
    v_MainLoginlayer.init();

    v_RegisterLayer = new CRegisterLayer();
    m_MainFrameLayer.addChild(v_RegisterLayer,200000);
    ...
    switch(obj.MsgId) {
        ...
        case 400:
        {
            switch(obj.MsgSubId)
            {
                ...
                case 401:
                {
                    ...
                    m_labelName.setString("昵称:"+m_userloginname_str);
        ...
        case 800: {
            ...
            if (MsgSubId == 803) {
                ...
                var m_gameserver = "ws://" + obj.Room[4].serverip + ":" + obj.Room[4].serverport;
