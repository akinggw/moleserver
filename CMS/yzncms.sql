...
INSERT INTO `yzn_admin` VALUES (1,'admin','9724b5e6c56b95f5723009ef81961bfe',1,'Wo0bAa','御宅男',1572511531,2130706433,'530765310@qq.com',1),(2,'ken678','932e31f030b850a87702a86c0e16db16',2,'Sxq6dR','御宅男',1542781151,2130706433,'530765310@qq.com',1);
...
CREATE TABLE `yzn_adminlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=283 DEFAULT CHARSET=utf8 COMMENT='操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-10-31 16:47:23
