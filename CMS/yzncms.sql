...
INSERT INTO `yzn_admin` VALUES (1,'admin','9724b5e6c56b95f5723009ef81961bfe',1,'Wo0bAa','御宅男',1572685726,2130706433,'530765310@qq.com',1),(2,'ken678','932e31f030b850a87702a86c0e16db16',2,'Sxq6dR','御宅男',1542781151,2130706433,'530765310@qq.com',1);
...
CREATE TABLE `yzn_adminlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=298 DEFAULT CHARSET=utf8 COMMENT='操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `yzn_cache` (
  ...
  PRIMARY KEY (`id`),
  KEY `ckey` (`key`)
) ENGINE=MyISAM AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='缓存列队表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `yzn_menu` (
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`parentid`)
) ENGINE=MyISAM AUTO_INCREMENT=215 DEFAULT CHARSET=utf8 COMMENT='后台菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-11-02 17:11:59
